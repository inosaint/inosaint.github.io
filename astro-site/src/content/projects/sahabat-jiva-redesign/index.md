...
## Challenge
Jiva had started off in the pandemic and we hadnt got a chance to observe our users on the ground. When travel started back up and we started investing into qualitative research, we started noticing
that our users really struggled to use the app. 
