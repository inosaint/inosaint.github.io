...
image: './zoom.png'
---
As the GoMerchant team grew, processes and rituals became very important.

### 1. Design Critiques
Design Critiques were the first one we instituted. This was a design and research only session where designers could present their work to other designers.
These would be weekly and designers were encouraged to show work in progress. To setup this session as a safe space, leaders wwere expected to be vulnerable and lead by showing their own work in progress.

### 2. Design Review
With a need to showcasing our work and drive alignment with non-design stakeholders, we setup a Design Review. The format of the design review was formal compared to our informal design critique. We invited non-design stakeholders to the review so that the feedback we collect could flow back into the design process.
...
This ritual couldn't have be achieved without the team members especially Maji, Lauditta and Aryo driving the conversations.
